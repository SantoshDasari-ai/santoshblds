...
const RagAi: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="w-full px-4 sm:px-6 lg:px-12 py-12 lg:py-24">
        <motion.div
          ...
          <article className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <header className="px-8 py-12 border-b border-gray-100 bg-gradient-to-br from-gray-50 to-white">
              ...
              <div className="mb-4 text-blue-600 font-medium">
                Lead Developer: Santosh Dasari
              </div>
              <p className="text-lg text-gray-600 max-w-3xl">
                A modern knowledge management system leveraging RAG technology
                for efficient information organization, search, and retrieval.
              </p>
            </header>
                  ...
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <li className="bg-gray-50 p-6 rounded-xl">
                      ...
                      <p className="text-gray-600">
                        Utilizes Pinecone vector database for meaning-based
                        searches using cosine similarity for relevance
                        measurement.
                      </p>
                    </li>
                    <li className="bg-gray-50 p-6 rounded-xl">
                      ...
                      <p className="text-gray-600">
                        Powered by Google's Gemini 1.5 Flash for understanding
                        complex questions and generating relevant answers.
                      </p>
                    </li>
                    <li className="bg-gray-50 p-6 rounded-xl">
                      <h4 className="font-semibold text-gray-900 mb-2">
                      ...
                      <p className="text-gray-600">
                        Supports PDF and text document ingestion with efficient
                        processing, chunking, and indexing.
                      </p>
                    </li>
                    <li className="bg-gray-50 p-6 rounded-xl">
                      <h4 className="font-semibold text-gray-900 mb-2">
                      ...
                      <p className="text-gray-600">
                        User-friendly chat interface for natural conversational
                        interactions.
                      </p>
                    </li>
                  </ul>
